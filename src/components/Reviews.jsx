...
const Reviews = () => {
  return (
    <>
    <div className="relative hidden lg:block md:block top-[170rem] 2xl:top-[110rem] lg:top-[300vh] w-full px-[2rem] font-poppins ">
    ...
    <div className="absolute top-[263rem] left-0 md:hidden lg:hidden w-full font-poppins ">
      <div className=" w=full flex flex-col gap-4 ">
        ...
        <div className="relative">
          ...
          <div className="my-auto flex flex-col gap-10 pt-[3rem] p-3 text-center">
            <p className="text-[22px] ">
              Hear what some of our customers <br />
              have to say about our service and impact <br />
              it's impact on their business.
